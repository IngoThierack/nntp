...
Body.`
	...
	expectedOverviews := []MessageOverview{
		...
		MessageOverview{13, "Subject13", "Author", time.Date(2003, 10, 18, 19, 0, 0, 0, time.FixedZone("", 1800)), "<e@f.g>", []string{}, 0, 6004, []string{"Extra stuff"}},
	}
...
13	Subject13	Author	18 Oct 2003 19:00:00 +0030	<e@f.g>			6004	Extra stuff
.
290 Feature enabled
